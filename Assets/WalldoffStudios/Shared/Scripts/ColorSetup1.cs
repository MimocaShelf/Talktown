...
namespace WalldoffStudios.ToonCharacter
{
    ...
    public class ColorSetup1 : MonoBehaviour
    {
        ...
        private readonly int SelfShadingSize = Shader.PropertyToID("_SelfShadingSize");
        private readonly int HighLightSmoothness = Shader.PropertyToID("_HighlightSmoothness");
        private readonly int HighlightStrength = Shader.PropertyToID("_HighlightStrength");
        private readonly int ShadowStrength = Shader.PropertyToID("_ShadowStrength");
